...
echo "  • MCP SSE:           http://localhost:8765/sse"
echo "  • Web UI:            http://localhost:3080"
echo "  • WebSocket:         ws://localhost:8000/ws"
echo
echo "Features:"
echo "  • MCP Protocol support (stdio + SSE)"
echo "  • Longbow SDK — vector KNN, hybrid, filtered search"
echo "  • Graph operations — edges and traversal between memories"
echo "  • Sub-millisecond latency with Arrow Flight"
echo "  • Real-time WebSocket bridge"
echo "  • MCP Tools (9 total):"
echo "      - add_memory"
echo "      - search_memories"
echo "      - list_memories"
echo "      - delete_all_memories"
echo "      - hybrid_search_memories"
echo "      - search_similar_memory"
echo "      - filtered_search_memories"
echo "      - add_memory_edge"
echo "      - traverse_memory_graph"
echo
echo "To view logs:"
